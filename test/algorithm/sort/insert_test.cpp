...
#include <algorithm/sort/insert_sort.h>

TEST(InsertSortTest, InsertSortRandomTest) {
	...
	algorithm::sort::insert_sort(test_vec.begin(), test_vec.end());
...
TEST(InsertSortTest, InsertSortSmallTest) {
	std::vector<uint32_t> vec;
	std::default_random_engine rander;
